...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th2 25, 2023 lúc 10:39 PM
...
INSERT INTO `login` (`id`, `user`, `pass`, `role`, `email`, `name`) VALUES
(3, 'admin', 'admin', 1, NULL, NULL),
(4, 'adminvu', '123', 1, NULL, NULL),
(5, 'user123', '123', 0, NULL, NULL),
(6, 'uservu', '123', 0, NULL, NULL);
...
--
ALTER TABLE `baiviet`
  ADD CONSTRAINT `baiviet_ibfk_1` FOREIGN KEY (`ma_tgia`) REFERENCES `baiviet` (`ma_bviet`),
